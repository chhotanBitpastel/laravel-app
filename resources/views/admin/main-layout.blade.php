...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
          <a class="nav-link {{ (strpos(Route::currentRouteName(), 'dashboard') === 0) ? 'active' : '' }}" href="{{route('dashboard')}}" >
            <i class="nav-icon fas fa-tachometer-alt"></i>
            <P>Dashboard</P>
          </a>
          </li>     
          <li class="nav-item ">
            <a href="{{route('students.list')}}" class="nav-link {{ (strpos(Route::currentRouteName(), 'students') === 0) ? 'active' : '' }}" >
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023-2024 <a href="#">Admin Panel</a>.</strong>
    All rights reserved.
